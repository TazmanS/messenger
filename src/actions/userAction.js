import {LOGIN_USER, 
        USER_EXIT, 
        USER_NEW_NAME,
        USER_NEW_MESS} from './actionTypes'
...
export function RegisterNewUser(user){
    ...
    return async dispatch => {
        try{
            await axios.post('https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=AIzaSyD-ctZejTPwiu35s4F7ZydNru1fl7mXQpg', user )
